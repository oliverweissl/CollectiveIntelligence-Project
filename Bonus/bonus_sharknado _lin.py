...
class Hunter(Agent):
    ...
    def __init__(self,  *args, **kwargs):
        ...
        self.repr_energy = int(self.max_energy*0.90)
        self.consumption = 0.5 * (0.2*self.gene[0]+0.9)
    ...
    def change_position(self):
        ...
        if self.is_alive():
            ...
            if len(self.hunters_in_visual_radius) > 0 \
                ...
                self.energy -= self.max_energy * 0.3
                self.partner.energy -= self.partner.max_energy * 0.3
