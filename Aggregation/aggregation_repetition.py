...
experiment_p_join = 0.6
experiment_p_leave = 0.2

for experiment_i in range(50):
    print(f'currently doing run {experiment_i+1} out of 50.',end='\r')
    @deserialize
    @dataclass
    ...
    df = (
        ...
        .spawn_site("images/shadow_extralarge.png", 3*x//4 , y//2)
    ...
    dfs = df.snapshots
    pickle.dump(dfs,open(f"new_round/different/50runs/j.7_l.4_run{experiment_i}.p",'wb'))
