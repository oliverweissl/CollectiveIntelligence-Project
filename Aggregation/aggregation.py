...
experiment_p_join = 0.9
experiment_p_leave = 0.3
# for experiment_p_join in np.linspace(0,0.9,10,endpoint=True):
#     for experiment_p_leave in np.linspace(0,0.9,10,endpoint=True):
for experiment_i in range(100):
    ...
    pickle.dump(dfs,open(f"case2/round3_optimized_repetition/J0.9L0.3_{experiment_i}.p",'wb'))
